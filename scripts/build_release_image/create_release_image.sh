...
# chmod +x $WORKSPACE/build_utils/scripts/docker_utils/docker_push.sh
# chmod +x $WORKSPACE/build_utils/scripts/docker_utils/docker_tag.sh
...
sudo docker build -f $WORKSPACE/build_utils/docker/ci_stack/project_images/build_in_jenkins_image/dockerfile   --build-arg archive=$RELEASE_ARTEFACT_NAME -t $2 .
